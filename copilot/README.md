...
[Copilot documents](https://docs.github.com/en/copilot/concepts/agents/about-agent-skills#about-agent-skills) both `~/.agents/skills` and `~/.copilot/skills` as personal skill roots.
Shared skills are visible through the first;
only Copilot-specific skills belong in `copilot/skills`.

## Relocation

It is possible to set [`COPILOT_HOME`](https://docs.github.com/en/copilot/reference/copilot-cli-reference/cli-config-dir-reference#changing-the-location-of-the-configuration-directory).
An example could be `P:\caches\ai\copilot`.
